...
- Support for Claude Code, Codex, OpenCode, Cursor Agent, and Aider as interchangeable coding-agent backends
...
- Local dashboard with a live checkpoint timeline and Continuity Graph explorer
...
- Plugin SDK for custom verify signals
